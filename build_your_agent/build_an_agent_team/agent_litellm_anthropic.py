...
async def run_conversation(query):
    ...
    try:
        ...
        print(f"Agent '{weather_agent_gpt.name}' created using model '{MODEL_CLAUDE_SONNET}'.")
        ...
        print(f"❌ Could not create or run GPT agent '{MODEL_CLAUDE_SONNET}'. Check API Key and model name. Error: {e}")
